          ...
          /* schedulers : :: */[
            ...
            List.map((function (prim) {
                    return /* record */[/* contents */prim];
                        ...
                        return ReActor_Scheduler$Reactor.make(node_name);
                      }), $$Array.to_list(Caml_array.caml_make_vect(FFI_Runtime$Reactor.hardwareConcurrency - 1 | 0, 0))))
          ],
...
function trace(node, tracer) {
  return List.iter((function (param) {
                return ReActor_Scheduler$Reactor.trace(tracer, param);
              }), node[/* schedulers */1]);
}
