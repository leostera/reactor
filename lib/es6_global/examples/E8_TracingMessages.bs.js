...
var Log = Caml_exceptions.create("E8_TracingMessages-Reactor.DOMLogger.Log");
...
var Diff = Caml_exceptions.create("E8_TracingMessages-Reactor.Differ.Diff");

function f(env, config) {
  Curry._1(env[/* recv */3], (function (param) {
          if (param[0] === Diff) {
            var delta = ReActor_Utils$Reactor.Performance[/* now */0](/* () */0) - param[1][/* current_time */1] | 0;
