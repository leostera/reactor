...
function f(env, config) {
  Curry._1(env[/* recv */3], (function (param) {
          if (param[0] === Diff) {
            ...
            var self = ReActor_Process.Pid[/* toString */1](Curry._1(env[/* self */1], /* () */0));
...
function clock_f(env, config) {
  Curry._2(env[/* sleep */2], config[/* delay */0], (function () {
          ReActor.send(config[/* send_to */1], Curry._2(config[/* wrap */2], Curry._1(env[/* self */1], /* () */0), ReActor_Utils.Performance[/* now */0](/* () */0)));
          return Curry._1(env[/* loop */0], config);
        }));
  return config;
}
