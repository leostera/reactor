...
function noop(env, state) {
  if (state[/* counter */0] === 2112) {
    var p = ReActor_Process.Pid[/* toString */1](Curry._1(env[/* self */1], /* () */0));
...
function loop_noop(env, state) {
  Curry._2(env[/* sleep */2], 100, (function () {
          ...
          var pid = ReActor_Process.Pid[/* toString */1](Curry._1(env[/* self */1], /* () */0));
...
FFI_Runtime.defer((function () {
        var match = ReActor.where_is("slower_pid");
        if (match !== undefined) {
          var pid = match;
...
exports.noop = noop;
exports.loop_noop = loop_noop;
exports.named_slower_pid = named_slower_pid;
exports.anon_slower_pid = anon_slower_pid;
exports.pids = pids;
